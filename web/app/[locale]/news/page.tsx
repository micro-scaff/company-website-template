...
export default async function Page() {
  ...
  return (
    <StructurePage title={page("news")}>
      <Section title={section("intro")} tone="blue" wide />
      <Section title={section("categories")} tone="purple" wide />
      <Section title={section("newsList")} tone="green" href="/news/detail" linkLabel={section("viewNews")} wide />
